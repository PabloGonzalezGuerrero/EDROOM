#ifndef CCDISPLAYSMNG_H_
#define CCDISPLAYSMNG_H_
 ...
 *
 */
class CCDisplaysMng: public CEDROOMComponent {

public:

	/**
	 * \enum TEDROOMCCDisplaysMngSignal
	 * \brief Component Signal Enum Type
	 *
	 */
	 enum TEDROOMCCDisplaysMngSignal { EDROOMSignalTimeout, 
							EDROOMSignalDestroy, 
							SDisplaysStart, 
							SIncreaseDisplays, 
							SDisplaysReady };
	...
	/**
	 * \class CCDisplaysMng::CEDROOMMemory
	...
	//! Constructor
	CCDisplaysMng(TEDROOMComponentID id, TEDROOMUInt32 roomNumMaxMens, TEDROOMPriority roomtaskPrio, 
...
public:
	...
	enum TEDROOMCCDisplaysMngSignal { EDROOMSignalTimeout,
		...
		friend class CCDisplaysMng;

		//!component reference
		CCDisplaysMng &EDROOMcomponent;
		...
		//!Variables
		TEDROOMUInt8 *VDisplays7SegValue;




		//!Constructor
		EDROOM_CTX_Top_0 (CCDisplaysMng &act,
	...
	public:
		 ...
		 * \brief  
		 */
		void	FIncreaseDisplays();

		/**
		 * \brief  
		 */
		void	FProgDisplaysRefresh();

		/**
		 * \brief  
		 */
		void	FRefreshDisplays();

		/**
		 * \brief  
		 */
		void	FSendDisplaysReady();
	...
	protected:
		...
		//!Variables
		TEDROOMUInt8 VDisplays7SegValue[8];
	...
	public:
		...
		//! Constructor
		EDROOM_SUB_Top_0 (CCDisplaysMng &act );
