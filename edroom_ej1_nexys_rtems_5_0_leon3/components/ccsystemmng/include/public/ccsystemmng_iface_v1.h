...
public:
	...
	// ********************************************************************
		...
		public:
			...
			//! TEDROOMInt8 Data Pool Memory
			TEDROOMInt8	poolTEDROOMInt8[10+1];
			//! TEDROOMInt8 Data Pool Marks Memory
			bool	poolMarkTEDROOMInt8[10];
...
public:
	...
	enum TEDROOMCCSystemMngSignal { EDROOMSignalTimeout,
		...
		class CEDROOMPOOLTEDROOMInt8:public CEDROOMProtectedMemoryPool {
			public:
			CEDROOMPOOLTEDROOMInt8(TEDROOMUInt32 elemCount,TEDROOMInt8 *pMem, bool *pMarks);
			TEDROOMInt8	* AllocData();
		};
		CEDROOMPOOLTEDROOMInt8	& EDROOMPoolTEDROOMInt8;
